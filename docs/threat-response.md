...
6. Normal production stops at the explicit 32-Unit redemption profile. Dynamic-
   price expansion beyond 20 is allowed only for the tested 150-resource goal;
   it must preserve the 160-capacity buffer and never override survival logic.
